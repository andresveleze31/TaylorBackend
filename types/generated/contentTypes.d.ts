...
export interface ApiCapacidadProductoCapacidadProducto
  extends Schema.CollectionType {
  collectionName: 'capacidad_productos';
  info: {
    singularName: 'capacidad-producto';
    pluralName: 'capacidad-productos';
    displayName: 'CapacidadProducto';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::capacidad-producto.capacidad-producto',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiClienteCliente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ImagenCliente: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiServicioServicio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    LogoSvg: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiTestimonioTestimonio extends Schema.CollectionType {
  ...
  attributes: {
    Persona: Attribute.String;
    Cargo: Attribute.String;
    Calificacion: Attribute.Integer;
    Imagen: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Testimonio: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::capacidad-producto.capacidad-producto': ApiCapacidadProductoCapacidadProducto;
